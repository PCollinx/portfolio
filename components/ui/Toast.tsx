...
export function Toast({
  ...
  return (
    <motion.div
      ...
      className={`
        w-full sm:max-w-sm ${styles.bg} border rounded-lg shadow-lg pointer-events-auto 
      ...
      <div className="p-3 sm:p-4">
        <div className="flex items-start">
          ...
          <div className="ml-2 sm:ml-4 flex-shrink-0 flex">
            <button
              className={`
                inline-flex ${styles.message} hover:${styles.title} 
...
export function ToastContainer({
  ...
  return (
    <div className="fixed top-4 left-4 right-4 sm:top-4 sm:right-4 sm:left-auto sm:max-w-sm z-50 space-y-4">
      <AnimatePresence>
        {toasts.map((toast) => (
